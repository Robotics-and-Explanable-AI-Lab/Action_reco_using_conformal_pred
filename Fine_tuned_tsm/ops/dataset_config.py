...
def return_Assembly101(modality, evaluation_file):
    ...
    root_data = '/home/heman/second_ssd/aloha_dataframe'
    ...
    # Updated prefix: now includes "frame_" and uses 6-digit padding.
...
def return_dataset(dataset, modality, evaluation_file=None):
    ...
    # Override the number of classes for Assembly101 to 1380
